...
-->
    ...
    <body>
        ...
        <main>
            ...
            <section id="visi-misi" class="py-5" style="background: linear-gradient(to bottom, #f8fafc, #e2e8f0);">
            <div class="container">
                <div class="text-center mb-5" data-aos="fade-up">
                <h2 class="fw-bold text-primary">Visi & Misi</h2>
                <p class="text-muted">Tujuan dan arah pengembangan SLB Negeri 1 Tanjungpinang</p>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="card-body">
                        <h4 class="card-title text-success fw-semibold">Visi</h4>
                        <p class="card-text mt-3">
                            <b>Mewujudkan pelayanan Pendidikan bagi anak berkebutuhan khusus yang berilmu pengetahuan, berakhlak mulia, mandiri, kreatif dan inovatif</b>
                        </p>
                    </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="card shadow-sm border-0 h-100">
                    <div class="card-body">
                        <h4 class="card-title text-warning fw-semibold">Misi</h4>
                        <ul class="mt-3">
                        <p><b>Misi SLB Negeri 1 Tanjungpinang adalah sebagai berikut:</b></p>
                        <li>Mengembangkan potensi guru seoptimal mungkin dalam melaksanakan proses pembelajaran,</li>
                        <li>Memotivasi dan menumbuhkan rasa prcaya diri setiap siswa,</li>
                        <li>Meningkatkan kreatifitas,</li>
                        <li>Meningkatkan ketrampilan yang dapat mnjadi sumber penghasilan bagi anak didik (kwirausahaan),</li>
                        <li>Membentuk sekolah yang asri, religius, dan berbudaya</li>
                        <li>Meningkatkan disiplin dan etos krja warga sekolah</li>
                        <li>Menciptakan suasana kekeluargaan dalam segala situasi di sekolah</li>
                        </ul>
                    </div>
                    </div>
                </div>
