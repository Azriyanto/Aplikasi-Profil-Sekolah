        ...
        <section id="prestasi" class="py-5 bg-white">
            <div class="container">
                <div class="text-center mb-5">
                    <h2 class="fw-bold text-primary">Guru  dan Tendik SLBN1</h2>
                    <p class="text-muted">Guru dan Tendik SLB Negeri 1 Tanjungpinang</p>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up">
                        <div class="card h-100 shadow-sm border-0">
                            <a href="#">
                                <img src="{{ asset('uploads/foto-guru/'.$data->foto) }}" class="card-img-top" alt="{{ $data->judul }}" style="height: 500px; object-fit: cover;">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title">
                                    <h5 class="text-decoration-none text-dark">{{ $data->nama }}</h5>
                                    <h5 class="text-decoration-none text-dark">{{ $data->nip }}</h5>
                                    <h5 class="text-decoration-none text-dark">{{ $data->jabatan }}</h5>
                                    <h5 class="text-decoration-none text-dark">{{ $data->status }}</h5>
                                </h5>
                            </div>
                        </div>
                    </div>
