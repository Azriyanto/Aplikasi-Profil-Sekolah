        ...
        <section id="prestasi" class="py-5 bg-white">
            <div class="container">
                <div class="text-center mb-5">
                    <h2 class="fw-bold text-primary">Penguumuman</h2>
                    <p class="text-muted">Pengumuman yang di sampaikan dari Kepala Sekolah SLB Negeri 1 Tanjungpinang</p>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up">
                        <div class="card h-100 shadow-sm border-0">
                            <a href="{{ url('prestasi/'.$data->id) }}">
                                <img src="{{ asset('uploads/foto-componen/'.$data->foto) }}" class="card-img-top" alt="{{ $data->judul }}" style="height: 200px; object-fit: cover;">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="#" class="text-decoration-none text-dark">{{ $data->nama }}</a>
                                </h5>
                                <p class="card-text text-muted">{{ \Illuminate\Support\Str::limit(strip_tags($data->konten), 100) }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
