     ...
     <section class="section">
        <div class="row">
            ...
            <div class="card recent-sales overflow-auto">
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Tambah Data<span>| Guru</span></h5>
                            @if (session('error'))
                            ...
                            @endif
                         <form method="POST" action="storeguru" class="row" enctype="multipart/form-data">
                          @csrf
                              ...
                              <div class="tab-pane fade show active datasiswa" id="datasiswa">
                                  ...
                                  <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" id="nama" name="nama" class="form-control @error ('nama') is-invalid @enderror" spellcheck="false" required>
                                  ...
                                  <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="nip" name="nip" placeholder="198383738428" class="form-control" spellcheck="false" required>
                                    </div>  
                                  </div>

                                  <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                    <div class="form-group">
                                      <label for="upload">Foto 3x4 Formal</label>
                                  ...
                                  <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="jabatan" name="jabatan" placeholder="Contoh Guru" class="form-control" spellcheck="false" required>
                                    </div>  
                                  </div>
      
                                  <div class="mb-3">
                                    <div class="form-group">
                                        <label for="status"><span class="text-danger">* Status Jabatan (-) </span>Status</label>
                                        <input type="text" id="status" name="status" placeholder="contoh Kepala Sekolah" class="form-control" spellcheck="false" required>
                                    </div>  
                                  </div>
