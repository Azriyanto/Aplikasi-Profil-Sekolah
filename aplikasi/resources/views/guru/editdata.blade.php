...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/dataguru">Data Guru</a></li>
                        ...
                        <div class="card-body">
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" href="/creatguru">Tambah Data</a></li>
                                    <li><a class="dropdown-item" href="/editdataguru">Edit Data</a></li>
                                    <li><a class="dropdown-item" href="/#">Hapus Data</a></li>
                                </ul>
                            </div>
                        <h5 class="card-title">Daftar<span>| Guru</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <img src="{{ asset('uploads/foto-guru/'.$data->foto) }}" alt="pas foto" style="max-height: 50px;" class="rounded-circle">
                                    </td>
                                    <td>{{$data->nama}}</td>
                                    <td>{{$data->nip}}</td>
                                    <td>{{$data->jabatan}}</td>
                                    ...
                                    <td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{route('dataguru.update',$data->id)}}" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nip" class="form-label"><span class="text-danger">*</span>NIP</label>
                                                                <input type="text" id="nip" class="form-control" name="nip" value="{{ $data->nip }}" required>
                                                            </div>

                                                            <div class="mb-3">
                                                                <label for="jabatan" class="form-label"><span class="text-danger">*</span>Jabatan</label>
                                                                <input type="text" id="jabatan" class="form-control" name="jabatan" value="{{ $data->jabatan }}" required>
                                                            </div>

                                                            <div class="mb-3">
                                                                <label for="status" class="form-label"><span class="text-danger">* Status Jabatan</span>Status</label>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                @if ($data->foto)
                                                                    ...
                                                                    <img src="{{ asset('uploads/foto-guru/'.$data->foto) }}" alt="Foto lama" style="max-height: 100px;" class="mt-1">
                                                                @endif
                                        ...
                                        <form id="delete-form-{{ $data->id }}" action="{{ route('dataguru.destroy', $data->id) }}" method="POST" style="display: none;">
                                          @csrf
                                          @method('DELETE')
                                        </form>
