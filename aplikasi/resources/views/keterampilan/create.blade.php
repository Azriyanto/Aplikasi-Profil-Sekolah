    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/dataketerampilan" class="nav-link">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="/dataketerampilan">Components</a></li>
     ...
     <section class="section">
        <div class="row">
            ...
            <div class="card recent-sales overflow-auto">
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Tambah Data<span>| Keterampilan</span></h5>
                            @if (session('error'))
                            ...
                            @endif
                         <form method="POST" action="keterampilansimpan" class="row" enctype="multipart/form-data">
                          @csrf
                              ...
                              <div class="tab-pane fade show active datasiswa" id="datasiswa">
                                  ...
                                  <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="status" name="status" value="Keterampilan" class="form-control" spellcheck="false" readonly required>
                                    </div>  
                                  </div>
