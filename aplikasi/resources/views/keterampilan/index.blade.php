...
<body>
            ...
            <div class="row">
                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        <div class="card-body">
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" href="/tambahketerampilan">Tambah Data</a></li>
                        ...
                        <h5 class="card-title">Daftar<span>| Keterampilan</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <img src="{{ asset('uploads/foto-componen/'.$data->foto) }}" alt="pas foto" style="max-height: 100px;">
                                    </td>
                                    <td>{{$data->nama}}</td>
                                    <td>{{$data->status}}</td>
                                </tr>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; developer <strong></strong> to slbnegeri1tanjungpinang
    </div>
    <div class="credits">
