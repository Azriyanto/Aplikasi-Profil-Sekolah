                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('printlaporan.cetak') }}" class="btn btn-sm btn-outline-primary mt-3 m-2" style="float: right;" >
                               🖨 Cetak
                            </a>
                        ...
                        <h5 class="card-title">Data<span>| Murid</span></h5>
                        ...
                        <table id="tabelku" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->status}}</td>
                                    <td>
                                        <a href="{{ route('murid.edit', $data->id) }}" target="_blank" class="btn btn-sm btn-outline-warning">
                                           Edit
                                        </a>

                                        <button class="btn btn-sm btn-outline-danger delete-confirm" data-id="{{ $data->id }}" data-nama="{{ $data->nama }}">
                                          Hapus
                                        </button>

                                        <form id="delete-form-{{ $data->id }}" action="{{ route('datasiswa.destroy', $data->id) }}" method="POST" style="display: none;">
                                          @csrf
                                          @method('DELETE')
                                        </form>
                                        ...
                                        <a href="{{ route('murid.cetak', $data->id) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                          🖨 Cetak
                                        </a>
                                    </td>
                                </tr>
