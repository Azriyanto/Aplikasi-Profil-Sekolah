    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/spmbmurid" class="nav-link">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Murid Baru (SPMB)</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data <span>| Murid SDLB</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{$jumlahMuridSDLB}}</h6>
                      <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridSDLB) }}%)</span> 
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data<span>| Murid SMPLB</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{$jumlahMuridSMPLB}}</h6>
                      <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridSMPLB) }}%)</span>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data<span>| Murid SMALB</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{$jumlahMuridSMALB}}</h6>
                      <span class="text-danger small pt-1 fw-bold">({{ number_format($persenMuridSMALB) }}%)</span>
              ...
              <div class="row">
                  ...
                  <div class="card recent-sales overflow-auto">
                      <div class="card">
                          ...
                          <h5 class="card-title">Data<span>| Murid TKLB</span></h5>
                              @if (session('success'))
                                <script>
                                  Swal.fire({
                                    icon: 'success',
