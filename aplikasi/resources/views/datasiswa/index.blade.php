          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">SPMB <span>| Murid Baru</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridBaru) }}%)</span> <span class="text-muted small pt-2 ps-1">SPMB</span>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Murid <span>| Kelulusan</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{$jumlahMuridlulus}}</h6>
                      <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridlulus) }}%)</span>
                      {{-- <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridlulus, 2) }}%)</span> --}}
                      <span class="text-muted small pt-2 ps-1">Kelulusan</span>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Murid<span>| Alumni</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <span class="text-danger small pt-1 fw-bold">({{ number_format($persenMuridalumni) }}%)</span>
                      <span class="text-muted small pt-2 ps-1">Alumni</span>
            ...
            <div class="row">
                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        ...
                        <h5 class="card-title">Data<span>| Kelulusan</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
            ...
            <div class="row">
                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        ...
                        <h5 class="card-title">Data<span>| Alumni</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
