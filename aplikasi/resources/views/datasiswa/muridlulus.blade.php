    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/muridlulus" class="nav-link">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Murid Lulus</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data <span>| Murid lulus SDLB</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{$jumlahMuridSDLBlulus}}</h6>
                      <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridSDLBlulus) }}%)</span> 
                      <span class="text-muted small pt-2 ps-1">SDLB</span>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data<span>| Murid lulus SMPLB</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{$jumlahMuridSMPLBlulus}}</h6>
                      <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridSMPLBlulus) }}%)</span>
                      {{-- <span class="text-success small pt-1 fw-bold">({{ number_format($persenMuridlulus, 2) }}%)</span> --}}
                      <span class="text-muted small pt-2 ps-1">SMPLB</span>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Data<span>| Murid lulus SMALB</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{$jumlahMuridSMPLBlulus}}</h6>
                      <span class="text-danger small pt-1 fw-bold">({{ number_format($persenMuridSMPLBlulus) }}%)</span>
                      <span class="text-muted small pt-2 ps-1">SMALB</span>
                        ...
                        <div class="card-body">
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" href="/muridedit">Edit Data</a></li>
                                    <li><a class="dropdown-item" href="/muridhapus">Hapus Data</a></li>
                                </ul>
                            </div>
                        <h5 class="card-title">Data<span>| SPMB</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
            ...
            <div class="row">
                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        ...
                        <h5 class="card-title">Data<span>| Murid SMP</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
            ...
            <div class="row">
                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        ...
                        <h5 class="card-title">Data<span>| Murid SMA</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
