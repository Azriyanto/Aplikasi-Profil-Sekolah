...
<body>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="/dataprestasi">Components</a></li>
     ...
     <section class="section">
        <div class="row">
            ...
            <div class="card recent-sales overflow-auto">
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Tambah Data<span>| Prestasi</span></h5>
                            @if (session('error'))
                            ...
                            @endif
                         <form method="POST" action="prestasisimpan" class="row" enctype="multipart/form-data">
                          @csrf
                              ...
                              <div class="tab-pane fade show active datasiswa" id="datasiswa">
                                  ...
                                  <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="status" name="status" value="Prestasi" class="form-control" spellcheck="false" readonly required>
                                    </div>  
                                  </div>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; developer slbnegeri1tanjungpinang
    </div>
    <div class="credits">
