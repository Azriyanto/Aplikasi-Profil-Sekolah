    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Hapus Data components</li>
        </ol>
      </nav>
    </div>
                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ url()->previous() }}" class="btn btn-secondary mt-2" style="float: right;">
                                ← Kembali
                            </a> 
                        <h5 class="card-title">Data<span>| Components</span></h5>
                        <!-- Table with stripped rows -->
                        <form action="{{ route('components.bulk-delete') }}" method="POST" id="bulk-delete-form">
                            @csrf
                            @method('DELETE')

                            <div class="mb-2">
                                <button type="button" class="btn btn-danger" id="delete-selected">Hapus Terpilih</button>
                                <button type="button" class="btn btn-warning" id="delete-all">Hapus Semua</button>
                            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($artikeldate as $data)
                                        <tr>
                                            <td><input type="checkbox" name="ids[]" class="checkbox-item" value="{{ $data->id }}"></td>
                                            <td>
  ...
  <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('delete-all').addEventListener('click', function () {
                Swal.fire({
                    title: 'Yakin?',
                    text: "Seluruh data murid akan dihapus permanen!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#d33',
                    cancelButtonColor: '#3085d6',
                    ...
                    if (result.isConfirmed) {
                        // Tambahkan input hidden untuk hapus semua
