...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Edit Data Components</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/dasboard">Components</a></li>
          <li class="breadcrumb-item active">Edit Data Components</li>
        </ol>
      </nav>
    </div>
                ...
                <div class="card recent-sales overflow-auto">
                    <div class="card">
                        <div class="card-body">
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" href="/tambahartikel">Tambah Data</a></li>
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                @foreach($artikeldate as $data)
                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>
                                      <img src="{{ asset('uploads/foto-componen/'.$data->foto) }}" alt="pas foto" style="max-height: 50px;">
                                    </td>
                                    <td>{{$data->nama}}</td>
                                    <td>{{$data->status}}</td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{route('datacomponents.update',$data->id)}}" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                @if ($data->foto)
                                                                    ...
                                                                    <img src="{{ asset('uploads/foto-componen/'.$data->foto) }}" alt="Foto lama" style="max-height: 100px;" class="mt-1">
                                                                @endif
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <fieldset class="form-group">
                                                                      <select class="form-select" id="status"
                                                                          ...
                                                                          <option value="Artikel" {{ old('status', $data->status) == 'Artikel' ? 'selected' : '' }}>Artikel</option>
                                                                          <option value="Pengumuman" {{ old('status', $data->status) == 'Pengumuman' ? 'selected' : '' }}>Pengumuman</option>
                                                                          <option value="Prestasi" {{ old('status', $data->status) == 'Prestasi' ? 'selected' : '' }}>Prestasi</option>
                                                                          <option value="Keterampilan" {{ old('status', $data->status) == 'Keterampilan' ? 'selected' : '' }}>Keterampilan</option>
                                                                          <option value="Galeri Kegiatan" {{ old('status', $data->status) == 'Galeri Kegiatan' ? 'selected' : '' }}>Galeri Kegiatan</option>
                                                                      </select>
                                                                  </fieldset>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="status" class="form-label"><span class="text-danger">*</span>Konten</label>
                                                                <textarea name="konten" id="kontent" rows="10" class="form-control" required>{{$data->konten}}</textarea>
                                                            </div>
                                        ...
                                        <form id="delete-form-{{ $data->id }}" action="{{ route('datacomponents.destroy', $data->id) }}" method="POST" style="display: none;">
                                          @csrf
                                          @method('DELETE')
                                        </form>
