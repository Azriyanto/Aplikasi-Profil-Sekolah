    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/galerikegiatan" class="nav-link">
            ...
            <div class="card recent-sales overflow-auto">
                <div class="card">
                    ...
                    <h5 class="card-title">Tambah Data<span>| Keterampilan</span></h5>
                            ...
                            @endif
                         <form method="POST" action="galerikegiatansimpan" class="row" enctype="multipart/form-data">
                          @csrf
                              ...
                              <div class="tab-pane fade show active datasiswa" id="datasiswa">
                                  ...
                                  <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="status" name="status" value="Galeri Kegiatan" class="form-control" spellcheck="false" readonly required>
                                    </div>  
                                  </div>
