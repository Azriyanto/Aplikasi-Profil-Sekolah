                        ...
                        <div class="card-body">
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" href="/editbener">Edit Data</a></li>
                                    <li><a class="dropdown-item" href="/">Hapus Data</a></li>
                                </ul>
                            </div>
                        <h5 class="card-title">Daftar<span>| Bener</span></h5>
                            @if (session('success'))
                              <script>
                                Swal.fire({
                                  icon: 'success',
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <img src="{{ asset('uploads/foto-Bener/'.$data->foto) }}" alt="pas foto" style="max-height: 100px;">
                                    </td>
                                    <td>{{$data->nama}}</td>
                                    <td>{{$data->status}}</td>
                                </tr>
