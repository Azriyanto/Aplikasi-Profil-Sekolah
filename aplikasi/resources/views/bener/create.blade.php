    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Bener</li>
        </ol>
      </nav>
    </div>
     ...
     <section class="section">
        <div class="row">
            ...
            <div class="card recent-sales overflow-auto">
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Tambah Data<span>| Bener</span></h5>
                            @if (session('error'))
                            ...
                            @endif
                         <form method="POST" action="storebener" class="row" enctype="multipart/form-data">
                          @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <fieldset class="form-group">
                                            <select class="form-select" id="status"
                                                ...
                                                <option value="menu hom" {{ old('status')=='menu hom' ? 'selected' : '' }}>
                                                    menu hom
                                                </option>
                                                <option value="menu SPMB" {{ old('status')=='menu SPMB' ? 'selected' : '' }}>
                                                    menu SPMB
                                                </option>
                                            </select>
                                        </fieldset>
