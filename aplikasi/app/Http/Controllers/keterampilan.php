...
class keterampilan extends Controller
{
    ...
    {
        $dataketerampilan = components::where('status', 'Keterampilan')->get();
        $infoberita = components::where('status', 'Artikel')
                    ->orderBy('created_at', 'desc')
                    ->take(3) // hanya ambil 3 data
                    ->get();
        return view('halaman.keterampilan', compact(['infoberita','dataketerampilan']));
    }
    ...
    public function dataketerampilan()
    {
        ...
        return view('keterampilan.index', compact(['profildatauser','dataketerampilan','newsupdates'])); 
    }
    ...
    public function create()
    {
        ...
        return view('keterampilan.create', compact(['profildatauser']));
    }
